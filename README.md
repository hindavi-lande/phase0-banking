...
`currencyCode` (ISO-4217, required, exactly 3 uppercase letters, immutable after creation)
...
curl -s -X POST localhost:8080/api/accounts \
  -H 'Content-Type: application/json' \
  -d "{\"customerId\":\"$ID\",\"accountNumber\":\"ACC-0001\",\"type\":\"SAVINGS\",\"balance\":250.00,\"status\":\"ACTIVE\",\"currencyCode\":\"USD\"}"
